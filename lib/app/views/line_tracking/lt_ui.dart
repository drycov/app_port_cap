...
class LineTrackerPage extends StatefulWidget {
  static const String route = 'polyline';

  const LineTrackerPage({Key? key}) : super(key: key);

  @override
  State<LineTrackerPage> createState() => _LineTrackerPageState();
}

class _LineTrackerPageState extends State<LineTrackerPage> {
